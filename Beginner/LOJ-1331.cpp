...
{
    int i,j,t,T;
    double r1,r2,r3,s,a,b,c,area,por,ans,ang1,ang2,ang3;
    scin(T);
    RUN_CASE(t,T)
    {
        ...
        ang2=acos((a*a+c*c-b*b)/(2.0*c*a));
        ang3=acos((a*a+b*b-c*c)/(2.0*a*b));
        por=(0.5*r1*r1*ang1)+(0.5*r2*r2*ang2)+(0.5*r3*r3*ang3);
        ans=area-(por);
        pf("Case %d: %0.10f\n",t,ans);
    }
    return 0;
